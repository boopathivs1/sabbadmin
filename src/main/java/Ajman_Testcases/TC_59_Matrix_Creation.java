...
public class TC_59_Matrix_Creation  extends ProjectWrapp
{
@BeforeClass(groups={"common"})
public void setDatag() {
	testCaseName="TC59 Matrix Creation";
...
//	.addMultislab(leftAddicon, leftuser, Operator, rightAddicon, rightuser, operatornum, MatricRoundNum)
