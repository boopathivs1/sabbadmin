...
public class TC_21_Create_Reject_Reason  extends ProjectWrapp
{
@BeforeClass(groups={"common"})
public void setDatag() {
	testCaseName="TC_21_Create_Reject_Reason";

	testDescription="Create Reject Reason";	
	browserName="Chrome";
...
.createRejectReason(Rejectcode,Rejectdesc)
.clicksaabCorporateRequestPage()
//.clickDatelinemenu()
.filterRequestFromAdminDateline("Dateline Reject Reason Request","Pending for Authorization")

.verifyAdminbuzz(auth1,auth2, "Dateline Reject Reason Creation Request")
