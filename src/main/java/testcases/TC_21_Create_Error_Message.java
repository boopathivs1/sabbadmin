...
public class TC_21_Create_Error_Message  extends ProjectWrapp
{
@BeforeClass(groups={"common"})
public void setDatag() {
	testCaseName="TC21 Create Error Message";

	testDescription="Create Error Message";	
	browserName="Chrome";
...
.clickerrorManage()
.createerrorManage()
.createerrorMessage(errorcode, ibmessage, ibarabic, coremessage, corearabic)
.clicksaabCorporateRequestPage()
.filterRequestFromAdminDateline("Error Message Management Request","Pending for Authorization")

.verifyAdminbuzz(auth1,auth2, "Error Message Management Creation Request")
